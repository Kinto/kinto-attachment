...
If you want to upload files which are not in the default allowed extensions (see `extensions groups <https://github.com/Kinto/kinto-attachment/blob/main/src/kinto_attachment/utils.py>`_ (default: ``default``):
